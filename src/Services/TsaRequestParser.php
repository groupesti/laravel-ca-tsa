...
class TsaRequestParser
{
    ...
    public function parse(string $tsqDer): array
    {
        try {
            ...
            CaLog::log('tsa_operation', 'info', "Timestamp request parsed: algorithm={$hashAlgorithm}, nonce=" . ($nonce ?? 'none'), [
                'operation' => 'tsa_parse_request',
            ...
            CaLog::critical($e->getMessage(), ['operation' => 'tsa_parse_request', 'exception' => $e::class]);
            throw $e;
        }
    }
